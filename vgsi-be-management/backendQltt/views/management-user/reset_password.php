 ...
 */
$this->title = Yii::t('backend', 'Reset password Management User: ') . ' ' . $model->first_name . ' ' . $model->last_name;
    ...
    <div class="panel panel-info">
        ...
        <div class="box ">
            ...
            <div class="box-body">
                ...
                ?>
                <?= Html::submitButton($model->isNewRecord ? Yii::t('backend', 'Reset') : Yii::t('backend', 'Reset'), ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']); ?>
                <?= Html::a(Yii::t('backend', 'Back'), Yii::$app->request->referrer, ['class' => 'btn btn-default']); ?>
                <?php
                ActiveForm::end();
                ?>
