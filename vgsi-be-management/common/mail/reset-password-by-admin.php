...
<td style="width: 612px;">
    ...
    <p style="font-family: -apple-system,BlincMacSystemFont,Helvetica Neue,Helvetica,Lucida Grande,tahoma,verdana,arial,sans-serif; font-size: 16px; line-height: 24px; color: #4b4f56; word-break: break-word;">Admin đã thực hiện khôi phục mật khẩu trên hệ thống quản lý dự án. 
    </p>
