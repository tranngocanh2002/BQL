...
/**
 * This is the model class for table "management_notify_receive_config".
 *
 * @property int $id
 ...
 */
class ManagementNotifyReceiveConfig extends \yii\db\ActiveRecord
{
    ...
    public static $action_list = [
        self::NOT_RECEIVED => 'Không nhận',
        self::RECEIVED => 'Có nhận',
    ];
    ...
    {
        return 'management_notify_receive_config';
    }
    ...
    {
        return [
            [['building_cluster_id', 'management_user_id'], 'required'],
            [['building_cluster_id', 'management_user_id', 'channel', 'type', 'action_create', 'action_update', 'action_cancel', 'action_delete', 'action_approved', 'action_comment', 'action_rate', 'created_at', 'updated_at'], 'integer'],
        ];
    }
