...
/**
 * This is the model class for table "service_building_info".
 *
 * @property int $id
 ...
 */
class ServiceBuildingInfo extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['tmp_end_date', 'building_cluster_id', 'building_area_id', 'apartment_id', 'service_map_management_id', 'start_date', 'end_date', 'created_at', 'updated_at', 'created_by', 'updated_by'], 'integer'],
        ];
    }
    ...
    {
        return $this->hasOne(ServiceBuildingConfig::className(), ['building_cluster_id' => 'building_cluster_id']);
    }
