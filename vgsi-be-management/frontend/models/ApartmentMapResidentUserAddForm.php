...
class ApartmentMapResidentUserAddForm extends Model
{
    ...
    {
        return [
            [['resident_phone', 'apartment_id', 'type','birthday','gender','resident_email','ngay_dang_ky_tam_chu','ngay_dang_ky_nhap_khau','cmtnd','ngay_cap_cmtnd','noi_cap_cmtnd','is_check_cmtnd'], 'required'],
            [['resident_name', 'resident_phone', 'resident_email', 'cmtnd', 'noi_cap_cmtnd', 'nationality', 'work', 'so_thi_thuc'], 'string'],
            [['birthday', 'gender', 'apartment_id', 'type', 'type_relationship','ngay_cap_cmtnd', 'ngay_dang_ky_nhap_khau', 'ngay_dang_ky_tam_chu', 'ngay_het_han_thi_thuc','is_check_cmtnd'], 'integer'],
