...
class ResidentUserSearch extends ResidentUser
{
    ...
    public function search($params)
    {
        ...
        $query = ResidentUserResponse::find()
            ->joinWith('apartmentMapResidentUsers')
            ->where(['apartment_map_resident_user.building_cluster_id' => $user->building_cluster_id])
    ...
    public function searchOld($params)
    {
        ...
        $query->andFilterWhere(['like', 'email', $this->email])
            ->andFilterWhere(['or',['like', 'phone', $this->phone], ['like', 'phone', preg_replace('/^0/', '84', $this->phone)]])
            ->andFilterWhere(['like', 'name_search', CVietnameseTools::removeSigns2($this->name)])
            ->andFilterWhere(['like', 'name_search', CVietnameseTools::removeSigns2($this->first_name)])
            ->andFilterWhere(['like', 'last_name', $this->last_name]);
