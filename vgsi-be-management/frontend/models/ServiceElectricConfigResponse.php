 ...
 * @SWG\Definition(
 *   type="object",
 *   @SWG\Xml(name="ServiceElectricConfigResponse")
 * )
 */
class ServiceElectricConfigResponse extends ServiceElectricConfig
{
    /**
    ...
    public function fields()
    {
        return [
            ...
            'type_name' => function($model){
                return ServiceElectricConfig::$arrType[$model->type];
            },
