...
/**
 * ServiceElectricInfoSearch represents the model behind the search form of `common\models\ServiceElectricInfo`.
 */
class ServiceElectricInfoSearch extends ServiceElectricInfo
{
    /**
     * {@inheritdoc}
     */
    ...
    public function search($params)
    {
        ...
        $query = ServiceElectricInfoResponse::find()->with(['apartment', 'serviceMapManagement'])->where(['building_cluster_id' => $buildingCluster->id]);
