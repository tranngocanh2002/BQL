...
class ServiceUtilityPriceSearch extends ServiceUtilityPrice
{
    ...
    {
        return [
            [['id', 'building_cluster_id', 'service_utility_free_id', 'service_utility_config_id', 'price_hourly', 'price_adult', 'price_child', 'current_time'], 'integer'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query = ServiceUtilityPriceResponse::find()->where(['building_cluster_id' => $buildingCluster->id]);
