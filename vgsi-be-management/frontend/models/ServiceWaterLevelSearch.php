...
/**
 * ServiceWaterLevelSearch represents the model behind the search form of `common\models\ServiceWaterLevel`.
 */
class ServiceWaterLevelSearch extends ServiceWaterLevel
{
    /**
     * {@inheritdoc}
     */
    ...
    public function search($params)
    {
        ...
        $query = ServiceWaterLevelResponse::find()->where(['building_cluster_id' => $buildingCluster->id]);
        ...
        $query->andFilterWhere(['or', ['like', 'name', $this->name], ['like', 'name', $this->name]])
