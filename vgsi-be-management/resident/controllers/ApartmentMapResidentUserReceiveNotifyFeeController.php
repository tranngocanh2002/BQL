...
use resident\models\ApartmentMapResidentUserReceiveNotifyFeeForm;
use resident\models\ApartmentMapResidentUserReceiveNotifyFeeResponse;
use resident\models\ApartmentMapResidentUserReceiveNotifyFeeSearch;
use Yii;
...
class ApartmentMapResidentUserReceiveNotifyFeeController extends ApiController
{
     ...
     *      tags={"ApartmentMapResidentUserReceiveNotifyFee"},
     *      @SWG\Parameter(in="header", name="X-Luci-Language", required=false, type="string", default="vi-VN", description="Language, format vi-VN, en-US"),
     *      @SWG\Parameter(in="query", name="apartment_id", type="integer", default=1, description="id căn hộ"),    *      @SWG\Parameter(in="query", name="sort", type="string", default="", description="Sort by:<br/> <b>+-name</b>: Tên ApartmentMapResidentUserReceiveNotifyFee <br/><b>+-status</b>: Trạng thái"),
    ...
    public function actionDetail($id)
    {
        ...
        $post = ApartmentMapResidentUserReceiveNotifyFeeResponse::findOne(['id' => (int)$id, 'building_cluster_id' => $buildingCluster->id]);
        return $post;
    }
