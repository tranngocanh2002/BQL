...
use resident\models\HelpResponse;
use resident\models\HelpSearch;
use Yii;
...
class HelpController extends ApiController
{
     ...
     *      @SWG\Parameter(in="query", name="help_category_id", type="integer", default="", description="help category id"),
     ...
     *                      @SWG\Items(type="object", ref="#/definitions/HelpResponse"),
     *                  ),
     ...
     * @SWG\Get(
     *      path="/help/detail",
     *      operationId="Help detail",
     *      summary="Help",
     *      consumes = {"application/json"},
     *      produces = {"application/json"},
     *      tags={"Help"},
     *      @SWG\Parameter(in="header", name="X-Luci-Language", required=false, type="string", default="vi-VN", description="Language, format vi-VN, en-US"),
     *      @SWG\Parameter( in="query", name="id", type="integer", default="1", description="id Help" ),
     *      @SWG\Response(response=200, description="Info",
     *          @SWG\Schema(type="object",
     *              @SWG\Property(property="success", type="boolean"),
     *              @SWG\Property(property="statusCode", type="integer", default=200),
     *              @SWG\Property(property="data",  type="object", ref="#/definitions/HelpResponse"),
     *          ),
     *      ),
     *      security = {
     *         {
    ...
    {
        $help = HelpResponse::findOne(['id' => (int)$id]);
        return $help;
    }
