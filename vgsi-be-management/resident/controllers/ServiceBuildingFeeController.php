...
use resident\models\ServiceBuildingFeeResponse;
use resident\models\ServiceBuildingFeeSearch;
use Yii;
...
class ServiceBuildingFeeController extends ApiController
{
    ...
    /**
     * @SWG\Get(
     *      path="/service-building-fee/detail",
    ...
    {
        return ServiceBuildingFeeResponse::findOne(['id' => (int)$id]);
    }
