...
/**
 * ServiceElectricFeeSearch represents the model behind the search form of `common\models\ServiceElectricFee`.
 */
class ServiceElectricFeeSearch extends ServiceElectricFee
{
    /**
     * {@inheritdoc}
     */
    ...
    public function search($params)
    {
        ...
        $query = ServiceElectricFeeResponse::find()->with(['apartment', 'serviceMapManagement']);
        ...
        $query->where(['building_cluster_id' => $apartmentMapResidentUser->building_cluster_id, 'status' => ServiceElectricFee::STATUS_ACTIVE]);
