 ...
 * @SWG\Definition(
 *   type="object",
 *   @SWG\Xml(name="ServiceElectricInfoResponse")
 * )
 */
class ServiceElectricInfoResponse extends ServiceElectricInfo
{
    /**
     ...
     * @SWG\Property(property="config", type="object", ref="#/definitions/ServiceElectricConfigResponse"),
...
//            },
            'config' => function($model){
                return ServiceElectricConfigResponse::findOne(['service_map_management_id' => $model->service_map_management_id]);
            },
            'level' => function($model){
                return ServiceElectricLevelResponse::find()->where(['service_map_management_id' => $model->service_map_management_id])->all();
            },
            'created_at',
            'updated_at',
        ];
