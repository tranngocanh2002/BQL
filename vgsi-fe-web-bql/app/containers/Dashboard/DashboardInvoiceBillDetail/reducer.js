/*
 *
 * DashboardInvoiceBillDetail reducer
 *
 */
...
function dashboardInvoiceBillDetailReducer(state = initialState, action) {
  switch (action.type) {
    case DEFAULT_ACTION:
      return initialState;
...
export default dashboardInvoiceBillDetailReducer;
