    ...
    return (
      <Page inner loading={!record || serviceAdd.detail.loading}>
        <Row style={{ paddingTop: 24 }}>
          {!!record && (
            <Form {...formItemLayout}>
              <Form.Item label={<FormattedMessage {...messages.serviceName} />}>
                  ...
                  rules: [
                    {
                      required: true,
                      message: (
                        <FormattedMessage {...messages.errorEmptyServiceName} />
                      ),
                      whitespace: true,
                    },
                  ],
              ...
              <Form.Item label={<FormattedMessage {...messages.contractor} />}>
                {getFieldDecorator("service_provider_id", {
                  ...
                  rules: [
                    {
                      required: true,
                      message: (
                        <FormattedMessage {...messages.errorEmptySupplier} />
                      ),
                      whitespace: true,
                    },
                  ],
                  ...
                  <Select
                    ...
                    showSearch
                    placeholder={
                      <FormattedMessage {...messages.selectSupplier} />
                    }
              ...
              <Form.Item
                label={<FormattedMessage {...messages.introduce} />}
