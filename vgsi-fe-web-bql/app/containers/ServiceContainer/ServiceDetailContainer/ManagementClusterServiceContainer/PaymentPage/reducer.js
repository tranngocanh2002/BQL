/*
 *
 * PaymentManagementClusterPage reducer
 *
 */
...
function paymentManagementClusterPageReducer(state = initialState, action) {
  switch (action.type) {
    case DEFAULT_ACTION:
      return initialState;
...
export default paymentManagementClusterPageReducer;
