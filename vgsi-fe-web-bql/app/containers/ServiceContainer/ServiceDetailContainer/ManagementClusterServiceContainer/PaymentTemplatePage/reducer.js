/*
 *
 * PaymentTemplateManagementClusterPage reducer
 *
 */
...
function paymentTemplateManagementClusterPageReducer(
  state = initialState,
  action
) {
  switch (action.type) {
...
export default paymentTemplateManagementClusterPageReducer;
