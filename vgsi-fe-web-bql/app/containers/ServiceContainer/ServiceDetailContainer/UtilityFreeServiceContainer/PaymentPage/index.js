...
export class PaymentPage extends React.PureComponent {
  ...
  _onDelete = (record) => {
    ...
    Modal.confirm({
      ...
      title: "Bạn chắc chắn muốn xoá thông tin thanh toán này?",
      okText: "Đồng ý",
      okType: "danger",
      cancelText: "Huỷ",
      onOk: () => {
  ...
  render() {
    ...
    const columns = [
      ...
      {
        width: 200,
        title: <span className={styles.nameTable}>Căn hộ</span>,
      ...
      {
        title: <span className={styles.nameTable}>Mô tả</span>,
        dataIndex: "description",
        key: "description",
        // render: (text) => <span className={styles.nameTable} >{text}</span>
      },
      {
        title: <span className={styles.nameTable}>Số tiền</span>,
        dataIndex: "price",
        key: "price",
        render: (text) => (
      ...
      {
        title: <span className={styles.nameTable}>Tình trạng</span>,
        dataIndex: "status",
        key: "status",
        render: (text, record) => (
          <span>
      ...
      {
        title: <span className={styles.nameTable}>Tháng</span>,
      ...
      {
        width: 170,
        title: <span className={styles.nameTable}>Cập nhật</span>,
      ...
      <Row>
        ...
        <Col>
          <Table
            ...
            //   return {
            //     onClick: event => {
            //       this.props.history.push(`/main/service/detail/utility-free/payment/detail/${record.id}`, {
            //         record
            //       })
            //     }
            //   };
...
export default compose(withReducer, withSaga, withConnect)(PaymentPage);
