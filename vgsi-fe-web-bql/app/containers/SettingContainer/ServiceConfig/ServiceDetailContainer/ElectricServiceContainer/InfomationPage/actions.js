/*
 *
 * InfomationElectricPage actions
 *
 */
...
export function fetchElectricConfig(payload) {
  return {
...
export function fetchElectricConfigComplete(payload) {
  return {
...
export function updateElectricConfig(payload) {
  return {
...
export function updateElectricConfigComplete(payload) {
  return {
