/*
 *
 * InfomationManagementClusterPage reducer
 *
 */
...
function infomationManagementClusterPageReducer(state = initialState, action) {
  switch (action.type) {
    case DEFAULT_ACTION:
      return initialState;
...
export default infomationManagementClusterPageReducer;
