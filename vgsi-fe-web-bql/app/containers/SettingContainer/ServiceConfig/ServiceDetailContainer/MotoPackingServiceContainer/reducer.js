/*
 *
 * MotoPackingServiceContainer reducer
 *
 */
...
import { UPDATE_SERVICE_DETAIL, UPDATE_SERVICE_DETAIL_COMPLETE } from "./InfomationPage/constants";
...
function motoPackingServiceContainerReducer(state = initialState, action) {
  switch (action.type) {
    case DEFAULT_ACTION:
      return initialState;
...
export default motoPackingServiceContainerReducer;
