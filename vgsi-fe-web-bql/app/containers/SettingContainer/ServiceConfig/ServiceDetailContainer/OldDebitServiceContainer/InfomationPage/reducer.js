/*
 *
 * InfomationOldDebitPage reducer
 *
 */

import { fromJS } from "immutable";
import { DEFAULT_ACTION, FETCH_SERVICE_PROVIDER, FETCH_SERVICE_PROVIDER_COMPLETE, UPDATE_SERVICE_DETAIL, UPDATE_SERVICE_DETAIL_COMPLETE, FETCH_OLD_DEBIT_CONFIG_COMPLETE } from "./constants";
...
function infomationOldDebitPageReducer(state = initialState, action) {
  switch (action.type) {
    case DEFAULT_ACTION:
      return initialState;
    ...
    case FETCH_OLD_DEBIT_CONFIG_COMPLETE: {
...
export default infomationOldDebitPageReducer;
