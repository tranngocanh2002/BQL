/*
 *
 * InfomationUtiliityFreePage reducer
 *
 */
...
function infomationUtiliityFreePageReducer(state = initialState, action) {
  switch (action.type) {
    case DEFAULT_ACTION:
      return initialState;
...
export default infomationUtiliityFreePageReducer;
