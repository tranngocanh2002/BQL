/*
 *
 * UtilityFreeServiceContainer reducer
 *
 */
...
function utilityFreeServiceContainerReducer(state = initialState, action) {
  switch (action.type) {
    case DEFAULT_ACTION:
      return initialState;
...
export default utilityFreeServiceContainerReducer;
