...
export class ResetPassword extends React.PureComponent {
  ...
  handleOk = () => {
    ...
    validateFieldsAndScroll((errors, values) => {
      ...
      dispatch(createPasswordAction({ ...values, token: this.state.token }));
    });
  };
  ...
  componentWillReceiveProps(nextProps) {
    if (
      this.props.resetPassword.successCreate !=
        nextProps.resetPassword.successCreate &&
      nextProps.resetPassword.successCreate
    ) {
      setTimeout(() => {
  ...
  render() {
    ...
    const { loading, successCreate } = resetPassword;
...
const mapStateToProps = createStructuredSelector({
  resetPassword: makeSelectCreatePassword(),
});
